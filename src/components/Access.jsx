...
export default function Access() {
  ...
  const getControllers = async () => {
    const data = await axios
      .get(`${BASE_URL}/get_all_controllers`, {
        headers: {
  ...
  const handleDelete = async (id) => {
    console.log(id);
    await axios
      .post(`${BASE_URL}/delete_controller`, {
        user_id: id,
      })
  ...
  const handleSubmit = async () => {
    await axios
      .post(`${BASE_URL}/add_controller`, details)
    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          ...
          >
            <Typography variant="div" sx={{ fontSize: "10px" }}>
              Automatic
            </Typography>
            <Switch />
            <Typography variant="div" sx={{ fontSize: "10px" }}>
        ...
        <Box className="flex flex-col gap-7 mx-auto w-2/5">
          ...
          <FormControl variant="filled" sx={{ m: 1 }}>
            ...
            <Select
              ...
              label="Access"
              onChange={(e) =>
                setDetails({ ...details, access: e.target.value })
              }
            >
                  ...
                  controllers.map((row, index) => (
                    ...
                    >
                      ...
                      <TableCell align="center">
                        <IconButton
                          onClick={() => handleDelete(row.controller_id)}
                        >
                          <Delete color="error" />
                        </IconButton>
                      </TableCell>
